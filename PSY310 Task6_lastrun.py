...
expName = 'PSY310 Task6'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\HP\\Downloads\\Shivangi PSY310\\Task6\\PSY310 Task6_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    display_text = visual.TextStim(win=win, name='display_text',
        text='Report the delay between the key press and beep sound (0-999) in ms; Click submit after enetering the value',
        font='Arial',
    ...
    trials = data.TrialHandler(nReps=40.0, method='random', 
        ...
        trialList=data.importConditions('C:/Users/HP/Downloads/in_cons - Sheet1.csv'),
    ...
    for thisTrial in trials:
        ...
        while continueRoutine:
            ...
            if polygon.status == NOT_STARTED and tThisFlip >= 2.0-frameTolerance:
                # keep track of start time/frame for later
